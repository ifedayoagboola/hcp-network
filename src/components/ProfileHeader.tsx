    ...
    <div className="flex flex-col md:flex-row items-start gap-4">
      ...
      <div className="flex flex-1 bg-white rounded-2xl shadow-base p-4 justify-between items-center h-24 w-full">
        ...
        <div className="flex items-center justify-center gap-4">
          <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="avatar" className="w-14 h-14 rounded-full" />
          <div className="flex-col items-start justify-center hidden lg:flex">
            <span className="font-bold text-lg text-gray-700 leading-tight">Emily Carter</span>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <div className="flex items-center gap-2 min-w-[180px]">
            <span className="text-sm text-gray-700 font-medium">
              My Peers: <span className="text-blue-600 font-semibold">232</span>
            </span>
            <span className="w-px h-4 bg-gray-300 inline-block" />
            <span className="text-sm text-gray-700 font-medium">
              Following: <span className="text-blue-600 font-semibold">124</span>
            </span>
          </div>
